...
class ConversationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create conversation" do
    assert_difference('Conversation.count') do
      post conversations_url, params: { conversation: { buyer_id: @conversation.buyer_id, seller_id: @conversation.seller_id } }
    end
  ...
  test "should update conversation" do
    patch conversation_url(@conversation), params: { conversation: { buyer_id: @conversation.buyer_id, seller_id: @conversation.seller_id } }
